...
export const api = {
  ...
  adminSuspenderCliente: (id) => request(`/api/admin/clientes/${id}/suspender`, { method: 'POST' }),
  adminReactivarCliente: (id) => request(`/api/admin/clientes/${id}/reactivar`, { method: 'POST' }),
